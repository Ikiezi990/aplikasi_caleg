            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="btn-group mb-2">
                        <a href="{{ route('provinsi.index') }}" class="btn btn-success">Refresh</a>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title fs-5" id="exampleModalLabel">Isi Data Provinsi</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title fs-5" id="exampleModalLabel">Isi
                                                                    Isi Data Provinsi</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form
                                                                    action="{{ route('provinsi.update', $row->id) }}"
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label for="nama_provinsi"
                                                                                    class="form-label">Nama Provinsi</label>
                                                ...
                                                <form action="{{ route('provinsi.destroy', $row->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
